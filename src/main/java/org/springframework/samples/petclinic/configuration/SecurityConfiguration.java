...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/duenosAdoptivos/show/**").hasAnyAuthority("director","cuidador")
				//.antMatchers("/duenosAdoptivos/**").hasAnyAuthority("director","cuidador","duenoadoptivo")
				.antMatchers("/duenosAdoptivos").hasAnyAuthority("director")
				...
				.antMatchers("/eventos/edit/**").hasAuthority("director")
				.antMatchers("/eventos/delete/**").hasAnyAuthority("director")
				...
				.antMatchers("/animales/listAnimales/**").hasAuthority("director")
				.anyRequest().denyAll()
				.and()
				 	.formLogin()
				 	/*.loginPage("/login")*/
