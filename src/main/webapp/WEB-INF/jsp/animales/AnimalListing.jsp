		...
		<tbody>
			<c:forEach items="${animales}" var="animal">
				<tr>
					...
					<td><c:out value="${animal.requisitos.licencia}" /></td>
					<td><c:out value="${animal.requisitos.seguro}" /></td>
					...
					<td><c:out value="${animal.categoria.tipo}" /></td>
					<td><c:out value="${animal.categoria.raza}" /></td>
