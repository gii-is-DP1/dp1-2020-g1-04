		...
		<form:form modelAttribute="adopcion" class="form-horizontal"
			...
			<div class="form-group has-feedback">
				<petclinic:inputField
					label="Cuántas personas constituyen su unidad familiar"
					name="unidadFamiliar" />
				<petclinic:inputField label="Cuántos son mayores de edad"
					name="mayoresDeEdad" />
				...
				<div class="form-group">
					<label>He leído y estoy de acuerdo con los requisitos de
						adopción</label>
					...
					<div class="col-sm-offset-2 col-sm-10">
						<c:choose>
							<c:when test="${adopcion['new']}">
								<button class="btn btn-default" type="submit">Solicitar
									Adopción</button>
							</c:when>
							<c:otherwise>
